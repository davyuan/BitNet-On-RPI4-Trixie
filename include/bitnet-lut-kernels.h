...
#pragma unroll
    for (int i = 0; i < BM640_2560; i += 32) {
        #pragma unroll
        for (int j=0; j<2; j++) {
            vec_c[j] = vandq_s16(vec_c[j], vec_zero);
        }
...
#pragma unroll
        for (int k = 0; k < KK / 2; k++) {
            ...
            vec_c[0] += vec_v_left_2.val[0];
            vec_c[0] += vec_v_right_2.val[0];
            vec_c[1] += vec_v_left_2.val[1];
            vec_c[1] += vec_v_right_2.val[1];
            ...
            vec_c[0] += vec_v_left_3.val[0];
            vec_c[0] += vec_v_right_3.val[0];
            vec_c[1] += vec_v_left_3.val[1];
            vec_c[1] += vec_v_right_3.val[1];
        }
